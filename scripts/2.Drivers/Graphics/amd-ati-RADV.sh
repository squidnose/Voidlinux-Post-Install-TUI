...
sudo xbps-install -Sy mesa-vaapi libspa-vulkan libva gstreamer1
...
sudo xbps-install -Sy mesa-vaapi-32bit libspa-vulkan-32bit libva-32bit gstreamer1-32bit

echo "Installing Radeontop and nvtop, usefull for finding info about GPU. Similar to nvidia-smi"
sudo xbps-install -Sy radeontop nvtop
