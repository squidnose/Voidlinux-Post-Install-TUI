#!/bin/bash
sudo xbps-install -Syu xorg wayland cinnamon-all xdg-desktop-portal-xapp
...
#==================================== Configs ====================================
##Title Name
TITLE="Cinnamon Desktop Installation Helper"
## Package list:
...
## XFCE4
    "cinnamon-all"      "Cinnamon Desktop - all packages" ON

## XDG
    "xdg-user-dirs-gtk"         "GTK+ tool to help manage user directories" ON
    "xdg-desktop-portal-xapp"    "Portal backend service for Flatpak using GTK+" ON
