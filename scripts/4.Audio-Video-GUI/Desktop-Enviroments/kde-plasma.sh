...
echo "Installing KDE integrations: Google-drive, Browser Inegration, Firewall Information gathering, Firmware(Local):"
sudo xbps-install -Sy kio-gdrive plasma-browser-integration ufw plasma-firewall clinfo qt6-wayland-tools aha drkonqi xdg-desktop-portal-kde fwupd
