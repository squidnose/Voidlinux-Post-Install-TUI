...
#==================================== Configs ====================================
##Title Name
TITLE="HW info and Config XBPS"
## Package list:
PACKAGES=(hwloc corectrl CPU-X LACT lm_sensors)
## Manual list entries:
## "TAG" "DESCRIPTION" "OFF/ON"
MANUAL_OPTIONS=(
    "hwloc"                 "Portable abstraction of hierarchical hardware architectures" OFF
    "corectrl"              "User-friendly hardware control application" OFF
    "CPU-X"                 "Free software that gathers information on CPU, motherboard and more" OFF
    "LACT"                  "Linux AMDGPU Control Application (Works for Others aswell)" OFF
    "lm_sensors"            "Utilities to read temperature/voltage/fan sensors" OFF
)
