...
TITLE="Media Apps"
## Package list:
PACKAGES=(codeblocks xterm logisim-evolution kate glade3)
## Manual list entries:
## "TAG" "DESCRIPTION" "OFF/ON"
MANUAL_OPTIONS=(
    "codeblocks"        "Free C, C++ and Fortran IDE" OFF
    "xterm"             "X Terminal Emulator(Usefull for Codeblocks)" OFF
    "logisim-evolution" "Digital logic design tool and simulator" OFF
    "kate"              "KDE Text editor(My favourite Code editor:)" OFF
    "glade3"            "User Interface Designer for GTK+3" OFF
)
