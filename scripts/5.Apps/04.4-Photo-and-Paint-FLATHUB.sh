...
#==================================== Configs ====================================
##Title Name
TITLE="Photo-&-Paint Flatpak"
## Package list:
PACKAGES=(io.gitlab.adhami3310.Converter org.gimp.GIMP org.kde.krita org.kde.kolourpaint org.tuxpaint.Tuxpaint)
## Manual list entries:
## "TAG" "DESCRIPTION" "OFF/ON"
MANUAL_OPTIONS=(
    "io.gitlab.adhami3310.Converter"        "Switchero - Convert Images into diferent formats" OFF
    "org.gimp.GIMP"                         "GNU image manipulation program" OFF
    "org.kde.krita"                         "Painting and image editing program" OFF
    "org.kde.kolourpaint"                   "Free, easy-to-use paint program for KDE" OFF
    "org.tuxpaint.Tuxpaint"                 "Free, award-winning drawing program for children ages 3 to 12" OFF
)
