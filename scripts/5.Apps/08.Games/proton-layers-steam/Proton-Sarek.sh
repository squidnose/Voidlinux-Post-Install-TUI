...
# Show whiptail menu
whiptail --title "$TITLE" --msgbox "There are 2 synch options:\n
asyc | Enables asynchronous pipeline compilation. This allows shaders to be compiled in the background.\n
<non-async> | Not with the feature above. Use if async doesnt work i guess. \n " 20 150
