...
#==================================== Configs ====================================
##Title Name
TITLE="Serial Comms Apps XBPS"
## Package list:
PACKAGES=(piper chirp arduino arduino-cli)
## Manual list entries:
## "TAG" "DESCRIPTION" "OFF/ON"
MANUAL_OPTIONS=(
    "piper"         "GTK application to configure gaming mice" OFF
    "chirp"         "Open-source tool for programming amateur radios" OFF
    "arduino"       "IDE for the arduino open-source electronics prototyping platform v 1.8" OFF
    "arduino-cli"   "Arduino command line interface" OFF
)
...
optional_script() {
if whiptail --title "$TITLE" --yesno "Add yourself to the Dialout group(For Adruino and Piper)" 15 60; then
