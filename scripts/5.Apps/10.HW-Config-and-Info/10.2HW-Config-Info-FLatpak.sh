...
#==================================== Configs ====================================
##Title Name
TITLE="HW info and Config Flatpak"
## Package list:
PACKAGES=(com.geekbench.Geekbench6 org.gnome.Firmware io.github.arunsivaramanneo.GPUViewer io.missioncenter.MissionCenter com.geeks3d.furmark)
## Manual list entries:
## "TAG" "DESCRIPTION" "OFF/ON"
MANUAL_OPTIONS=(
    "com.geekbench.Geekbench6"              "Benchmark SW" OFF
    "org.gnome.Firmware"                    "Firmware manager" OFF
    "io.github.arunsivaramanneo.GPUViewer"  "Detailed GPU info" OFF
    "io.missioncenter.MissionCenter"        "Task Manager like System Monitor" OFF
    "com.geeks3d.furmark"                   "GPU stress test" OFF
)
