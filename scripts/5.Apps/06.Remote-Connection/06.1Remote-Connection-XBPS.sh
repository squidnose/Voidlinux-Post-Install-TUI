...
#==================================== Configs ====================================
##Title Name
TITLE="Remote Connection Apps XPBS"
## Package list:
PACKAGES=(remmina remmina-kwallet tigervnc freerdp freerdp-server)
## Manual list entries:
## "TAG" "DESCRIPTION" "OFF/ON"
MANUAL_OPTIONS=(
    "remmina"                   "Remote desktop client written in GTK+" OFF
    "remmina-kwallet"           "Remote desktop client written in GTK+ - kwallet plugin" OFF
    "tigervnc"                  "High performance, multi-platform VNC client and server" OFF
    "freerdp"                   "Free RDP (Remote Desktop Protocol) client" OFF
    "freerdp-server"            "Free RDP (Remote Desktop Protocol) server" OFF
)
