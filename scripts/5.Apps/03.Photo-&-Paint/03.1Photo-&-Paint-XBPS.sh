...
#==================================== Configs ====================================
##Title Name
TITLE="Photo-&-Paint XBPS"
## Package list:
PACKAGES=(gwenview cheese gimp krita kolourpaint tuxpaint)
## Manual list entries:
## "TAG" "DESCRIPTION" "OFF/ON"
MANUAL_OPTIONS=(
    "gwenview"      "Fast and easy to use image viewer by KDE" OFF
    "cheese"        "GNOME tool to take pictures and videos from your webcam" OFF
    "gimp"          "GNU image manipulation program" OFF
    "krita"         "Painting and image editing program" OFF
    "kolourpaint"   "Free, easy-to-use paint program for KDE" OFF
    "tuxpaint"      "Free, award-winning drawing program for children ages 3 to 12" OFF
)
