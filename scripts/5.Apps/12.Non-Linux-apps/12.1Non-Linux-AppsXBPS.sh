...
#==================================== Configs ====================================
##Title Name
TITLE="Non Linux Apps XBPS"
## Package list:
PACKAGES=(dosbox dosbox-staging wine winegui wine-32bit wine-gecko wine-mono winetricks)
## Manual list entries:
## "TAG" "DESCRIPTION" "OFF/ON"
MANUAL_OPTIONS=(
    "dosbox"            "DOS x86 emulator with Tandy/Herc/CGA/EGA/VGA/SVGA graphics and sound" OFF
    "dosbox-staging"    "DOS/x86 emulator focusing on ease of use (Staging)" OFF
    "wine"              "Run Microsoft Windows applications" OFF
    "winegui"           "User-friendly WINE manager" OFF
    "wine-32bit"        "(Glibc Only!)Run Microsoft Windows applications (32bit)" OFF
    "wine-gecko"        "Mozilla Gecko Layout Engine for WINE (32bit)" OFF
    "wine-mono"         "Mono built for running .NET applications with WINE" OFF
    "winetricks"        "Script to install various redistributable runtime libraries in Wine" OFF
