...
sudo xbps-install nvidia580 nvidia580-libs-32bit nvidia580-opencl vulkan-loader vulkan-loader-32bit Vulkan-Headers Vulkan-Tools libspa-vulkan libspa-vulkan-32bit ocl-icd ocl-icd-32bit
