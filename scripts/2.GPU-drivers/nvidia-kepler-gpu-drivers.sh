...
sudo xbps-install nvidia470 nvidia470-libs-32bit nvidia470-opencl linux-lts linux-lts-headers vulkan-loader vulkan-loader-32bit Vulkan-Headers Vulkan-Tools libspa-vulkan libspa-vulkan-32bit ocl-icd ocl-icd-32bit
