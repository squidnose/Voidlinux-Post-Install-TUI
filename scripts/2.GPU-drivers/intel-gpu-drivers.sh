...
sudo xbps-install -Syu mesa-vaapi libspa-vulkan libva-intel-driver libva
...
sudo xbps-install -Syu mesa-vaapi-32bit libspa-vulkan-32bit libva-intel-driver-32bit libva-32bit
